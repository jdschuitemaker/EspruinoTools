...
(function() {
  ...
  function init() {
    Espruino.Core.Config.add("SERIAL_TCPIP", {
      ...
      description : "When connecting, add a menu item to connect to a given TCP/IP address (eg. `192.168.1.2` or `192.168.1.2:23`). Leave blank to disable. Separate multiple ip addressess with a semi-colon",
      type : "string",
      defaultValue : "", 
    });
  }  
